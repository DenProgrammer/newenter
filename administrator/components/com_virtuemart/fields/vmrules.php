        ...
        foreach ($groups as $group) {
            ...
            foreach ($actions as $action) {
                ...
                $html[]     = '<select '
                        ...
                        .'onchange="sendPermissions.call(this, event)" data-chosen="true" '
                        .'class="input-small" '
                        .'title="'.vmText::sprintf('JLIB_RULES_SELECT_ALLOW_DENY_GROUP', vmText::_($action->title), trim($group->text)).'" '
                        .'>';
