...
//]]>
     ...
     */
    static function popup($container, $activator, $options = null)
    {
        static $jspopup;

        $data = $options ? "{ div: '".$container."', content: con , $options}" : "{ div: '".$container."', content: con}";
    ...
    static function chosenDropDowns()
    {
        ...
        if (!$chosenDropDowns) {
            ...
            if (VmConfig::get('jchosen', 0) or $be) {
                ...
                $script = 'Virtuemart.updateChosenDropdownLayout = function() {
