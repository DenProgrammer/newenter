 ...
 * @package		VirtueMart
 */
class TableAssembly_medias extends VmTableXarray {
	...
	function __construct(&$db){
		parent::__construct('#__virtuemart_assembly_medias', 'id', $db);

		$this->setPrimaryKey('assembly_id');
		$this->setSecondaryKey('virtuemart_media_id');
		$this->setOrderable();

		$this->setTableShortCut('am');
	}
