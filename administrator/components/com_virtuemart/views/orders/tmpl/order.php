                    ...
                    <table class="adminlist table"  id="itemTable" >
                        <thead>
                            <tr>
                                ...
                                <th class="title" width="70"><?php echo vmText::_('COM_VIRTUEMART_PRODUCT_FORM_PRICE_NET') ?></th>
                                <th class="title" width="70"><?php echo vmText::_('COM_VIRTUEMART_ORDER_PRINT_TOTAL') ?></th>
                            </tr>
                        </thead>
                        <?php
                        $i = 1;
