            ...
            <table class="">
                <tr>
                    <td align="left">
                        ...
                        <select class="inputbox" id="virtuemart_category_id" name="virtuemart_category_id" onchange="this.form.submit();
                                return false;">
...
//                        echo vmJsApi::jDate(vRequest::getVar('search_date', $nowstring), 'search_date');
                        ...
                        <button  class="btn btn-small" onclick="document.adminForm.filter_product.value = '';
                                document.adminForm.search_type.options[0].selected = true;"><?php echo vmText::_('COM_VIRTUEMART_RESET'); ?></button>
                    </td>
