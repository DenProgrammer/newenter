...
<table width="100%" cellspacing="0" cellpadding="0" border="0">
    ...
    <tr>
        ...
        <td valign="top" align="left" width="50%"><?php echo $this->orderdetails['details']['BT']->note; ?></td>
    </tr>

    <tr>
        <td class="orders-key"><?php echo vmText::_('COM_VIRTUEMART_ORDER_PRINT_TOTAL') ?></td>
        <td class="orders-key" align="left"><?php echo (round($this->orderdetails['details']['BT']->order_total * $this->orderdetails['details']['BT']->exchange_usd))
                .' Сом / '.round($this->orderdetails['details']['BT']->order_total, 2).' $'; ?></td>
    </tr>
